...
public static class StringHelper
{
    ...
    //CatPokemon
    public const string IS_CHEAT_AD = "IS_CHEAT_AD";
    public const string CURRENT_RANDOMIZE_POWERUP = "CURRENT_RANDOMIZE_POWERUP";
    public const string CURRENT_HINT_POWERUP = "CURRENT_HINT_POWERUP";
}
...
public class PathPrefabs
{
    ...
    public const string WIN_BOX = "UI/Popups/WinPopup";
    ...
    public const string LOSE_BOX = "UI/Popups/LosePopup";
    ...
    //CatPokemon
    public const string GUIDELINE_BOX = "UI/Popups/GuidelinePopup";
    public const string RATE_BOX = "UI/Popups/RatePopup";
}
