...
public class UseProfile : MonoBehaviour
{
    ...
    public static bool IsCheatAd
    {
        get
        {
            return PlayerPrefs.GetInt(StringHelper.IS_CHEAT_AD, 0) == 1;
        }
        set
        {
            PlayerPrefs.SetInt(StringHelper.IS_CHEAT_AD, value ? 1 : 0);
            PlayerPrefs.Save();
        }
    }

    public int CurrentRandomizePowerup
    {
        get
        {
            return PlayerPrefs.GetInt(StringHelper.CURRENT_RANDOMIZE_POWERUP, 3);
        }
        set
        {
            PlayerPrefs.SetInt(StringHelper.CURRENT_RANDOMIZE_POWERUP, value);
            PlayerPrefs.Save();
        }
    }

    public int CurrentHintPowerup
    {
        get
        {
            return PlayerPrefs.GetInt(StringHelper.CURRENT_HINT_POWERUP, 3);
        }
        set
        {
            PlayerPrefs.SetInt(StringHelper.CURRENT_HINT_POWERUP, value);
            PlayerPrefs.Save();
        }
    }
}
