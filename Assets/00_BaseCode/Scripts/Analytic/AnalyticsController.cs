...
public class AnalyticsController : MonoBehaviour
{
    ...
    public const string aj_inters_ad_eligible = "vd2l2a";
    public const string aj_inters_api_called = "q1r89o";
    public const string aj_inters_displayed = "7fsa49";
    public const string aj_level_complete = "vcvezx";
    public const string aj_purchase = "1h6zpb";
    public const string aj_rewarded_ad_completed = "cv2fer";
    public const string aj_rewarded_ad_eligible = "lyxr7s";
    public const string aj_rewarded_api_called = "t4lsit";
    public const string aj_rewarded_displayed = "wz8q89";
    public const string aj_tutorial_completion = "n7nwdi";
