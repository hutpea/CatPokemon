...
public class ConfigBuild
{
    ...
    private static string KeyStorePath = "Assets/00_BaseCode/KeyStore/connectcat.keystore";
    ...
    [MenuItem("Open Scene/LoadingScene #1")]
    public static void OpenSceneStartLoading()
    {
        string localPath = "Assets/Scenes/_loadingScreen.unity";
    ...
    {
        string localPath = "Assets/Scenes/_gameplay.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
